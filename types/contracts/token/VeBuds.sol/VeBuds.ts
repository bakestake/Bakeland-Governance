...
export interface VeBudsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface VeBuds extends BaseContract {
  connect(runner?: ContractRunner | null): VeBuds;
  waitForDeployment(): Promise<this>;

  interface: VeBudsInterface;
