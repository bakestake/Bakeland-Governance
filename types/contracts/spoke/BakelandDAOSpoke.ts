...
export interface BakelandDAOSpokeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface BakelandDAOSpoke extends BaseContract {
  connect(runner?: ContractRunner | null): BakelandDAOSpoke;
  waitForDeployment(): Promise<this>;

  interface: BakelandDAOSpokeInterface;
