...
import { BakelandDAO__factory } from '../../typechain-types';
import { BakelandDAOHub__factory } from '../../types';

// tasks/cast-vote.js
task("update-spoke", "Casts a vote on a proposal in BakelandDAOHub")
  ...
  .setAction(async (taskArgs, hre) => {
    try{
        ...
        const tx = await BakelandDAOHub.updatePeerAddresses(chainIds, peers);
